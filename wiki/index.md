...
A knowledge base about **Younghwan Kil (길영환)** — maintained the way Karpathy keeps a
personal wiki: one durable, searchable, ever-growing place instead of scattered
documents. It exists primarily to write **cover letters (자기소개서)**, CVs, and research
statements from a single source of truth, so every page is written to be *reusable prose*,
not a bullet dump.
...
| [Projects]({{ '/wiki/projects/' \| relative_url }}) | One page per project (ASCG, PerioEDL, OralGNN, …) |
...
> (certificates, acceptance letters, manuscripts) kept privately outside this repo.
> Where a section needs the author's own words (motivations, anecdotes), it is marked
> **✍️ needs your voice** so it is never fabricated.
