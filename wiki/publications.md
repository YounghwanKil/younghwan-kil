...
1. **ASCG: Adaptive Spatial Classifier Guidance for Surgical Concept Suppression in
   ...
   2026. *Y. Kil, J. Park, G. Nam, J. Lee†.* → [project]({{ '/wiki/projects/ascg/' \| relative_url }})
2. **DATAN: Diffusion-Augmented Temporal Attention Network for ICU Mortality Prediction
   Under Sparse Clinical Observations.** International Conference on Precision Medicine &
   AI Healthcare (HealthAI 2026), Prague — Poster (accepted). *Y. Kil\*, S. K. Kim\*, S.
   Kim, Y. Kim, S. Yang, G. Manalu.* → [project]({{ '/wiki/projects/datan/' \| relative_url }})
3. **Uncertainty-Aware Deep Feature Interaction Attention Network for Reliable Type 2
   Diabetes Detection.** HealthAI 2026, Prague — Poster (accepted). *Y. Kil.*
