...
| **2025–2026** | Clinical-AI work (DBTAN, T2D detection, set-based temporal attention) | Uncertainty-aware medical models; 2 posters accepted to HealthAI 2026 (Prague). |
...
Industrial engineering (reliability under uncertainty) → first taste of medical AI at
AIRS → research internship at KAIST → strong undergraduate finish → M.S. in Trustworthy
AI, now running two parallel lines (generative-model safety + uncertainty-aware clinical
AI) with a growing publication record.
